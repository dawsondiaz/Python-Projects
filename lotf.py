...
text.print_slow("You see a boat passing the island, but there is no smoke on the mountain.\n")
island.boat()
obj12 =raw_input(Fore.CYAN + Style.BRIGHT + "What do you do?\na.) Swim towards the boat\nb.) Run up the mountain\n")
